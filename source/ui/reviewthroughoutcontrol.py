...
class Ui_ReviewThroughoutControl(object):
    ...
    def retranslateUi(self, ReviewThroughoutControl):
        ...
        self.previousman.setToolTip(_translate("ReviewThroughoutControl", "Move to previous maneuver"))
        self.previousman.setText(_translate("ReviewThroughoutControl", "|<"))
        self.nextman.setToolTip(_translate("ReviewThroughoutControl", "Move to next maneuver"))
