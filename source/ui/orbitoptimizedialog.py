...
class Ui_OrbitOptimizeDialog(object):
    def setupUi(self, OrbitOptimizeDialog):
        ...
        self.label_3.setGeometry(QtCore.QRect(60, 490, 111, 16))
        self.label_3.setObjectName("label_3")
        self.label_9 = QtWidgets.QLabel(OrbitOptimizeDialog)
        self.label_9.setGeometry(QtCore.QRect(220, 490, 181, 16))
        self.label_9.setObjectName("label_9")
        self.label_14 = QtWidgets.QLabel(OrbitOptimizeDialog)
        self.label_14.setGeometry(QtCore.QRect(230, 510, 41, 16))
        self.label_14.setObjectName("label_14")
        self.label_16 = QtWidgets.QLabel(OrbitOptimizeDialog)
        self.label_16.setGeometry(QtCore.QRect(230, 530, 41, 16))
        self.label_16.setObjectName("label_16")
        self.terminalRV_cur = QtWidgets.QLineEdit(OrbitOptimizeDialog)
        self.terminalRV_cur.setGeometry(QtCore.QRect(280, 510, 91, 18))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.terminalRV_cur.setFont(font)
        self.terminalRV_cur.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.terminalRV_min.setGeometry(QtCore.QRect(280, 530, 91, 18))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.terminalRV_min.setFont(font)
        self.terminalRV_min.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.label_18.setGeometry(QtCore.QRect(40, 530, 41, 16))
        self.label_18.setObjectName("label_18")
        self.initialDV_min = QtWidgets.QLineEdit(OrbitOptimizeDialog)
        self.initialDV_min.setGeometry(QtCore.QRect(90, 530, 91, 18))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.initialDV_min.setFont(font)
        self.initialDV_min.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.initialDV_cur.setGeometry(QtCore.QRect(90, 510, 91, 18))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.initialDV_cur.setFont(font)
        self.initialDV_cur.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.label_it.setGeometry(QtCore.QRect(250, 23, 81, 20))
        ...
        self.initialtime.setGeometry(QtCore.QRect(340, 22, 161, 20))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.initialtime.setFont(font)
        self.initialtime.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.label_itfrom.setGeometry(QtCore.QRect(5, 30, 71, 16))
        ...
        self.label_itto.setGeometry(QtCore.QRect(505, 30, 71, 16))
        ...
        self.it_b.setGeometry(QtCore.QRect(270, 76, 21, 22))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.it_f.setGeometry(QtCore.QRect(300, 76, 21, 22))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.it_ff.setGeometry(QtCore.QRect(560, 50, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.it_fb.setGeometry(QtCore.QRect(10, 50, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.duration.setGeometry(QtCore.QRect(150, 20, 81, 20))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        ...
        self.label_8.setGeometry(QtCore.QRect(250, 20, 81, 20))
        self.label_8.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_8.setObjectName("label_8")
        self.terminaltime = QtWidgets.QLineEdit(self.groupBox_6)
        self.terminaltime.setGeometry(QtCore.QRect(340, 20, 161, 20))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.terminaltime.setFont(font)
        self.terminaltime.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.label_ttto.setGeometry(QtCore.QRect(515, 40, 71, 16))
        ...
        self.label_ttfrom.setGeometry(QtCore.QRect(15, 40, 71, 16))
        ...
        self.tt_b.setGeometry(QtCore.QRect(270, 86, 21, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tt_f.setGeometry(QtCore.QRect(300, 86, 21, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tt_ff = QtWidgets.QPushButton(self.groupBox_6)
        self.tt_ff.setGeometry(QtCore.QRect(560, 60, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.totalDV_cur.setGeometry(QtCore.QRect(470, 509, 91, 18))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.totalDV_cur.setFont(font)
        self.totalDV_cur.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.label_22.setGeometry(QtCore.QRect(420, 510, 41, 16))
        self.label_22.setObjectName("label_22")
        self.clearstat = QtWidgets.QPushButton(OrbitOptimizeDialog)
        self.clearstat.setGeometry(QtCore.QRect(470, 560, 91, 23))
        ...
        self.idv_phi.setGeometry(QtCore.QRect(90, 560, 91, 18))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.idv_phi.setFont(font)
        self.idv_phi.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.idv_elv.setGeometry(QtCore.QRect(90, 580, 91, 18))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.idv_elv.setFont(font)
        self.idv_elv.setFocusPolicy(QtCore.Qt.NoFocus)
        ...
        self.label_23.setGeometry(QtCore.QRect(40, 560, 51, 16))
        self.label_23.setObjectName("label_23")
        self.label_24 = QtWidgets.QLabel(OrbitOptimizeDialog)
        self.label_24.setGeometry(QtCore.QRect(40, 580, 51, 16))
        self.label_24.setObjectName("label_24")
        self.reopenbutton = QtWidgets.QPushButton(OrbitOptimizeDialog)
        self.reopenbutton.setGeometry(QtCore.QRect(20, 620, 91, 23))
        ...
        OrbitOptimizeDialog.setTabOrder(self.totarget, self.check_orgorb)
        ...
        OrbitOptimizeDialog.setTabOrder(self.check_Ptrj, self.fixed_to_ct)
        ...
        OrbitOptimizeDialog.setTabOrder(self.clearstat, self.reopenbutton)
        OrbitOptimizeDialog.setTabOrder(self.reopenbutton, self.finishbutton)
    ...
    def retranslateUi(self, OrbitOptimizeDialog):
        ...
        self.box_initialtime.setTitle(_translate("OrbitOptimizeDialog", "Adjust Start Time"))
...
"Range"))
        ...
        self.groupBox_6.setTitle(_translate("OrbitOptimizeDialog", "Adjust Flight Time"))
...
"Range"))
        ...
        self.clearstat.setToolTip(_translate("OrbitOptimizeDialog", "Clear all Minimums"))
