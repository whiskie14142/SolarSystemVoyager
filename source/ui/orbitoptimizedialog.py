...
class Ui_OrbitOptimizeDialog(object):
    def setupUi(self, OrbitOptimizeDialog):
        ...
        self.label_17 = QtWidgets.QLabel(OrbitOptimizeDialog)
        ...
        self.terminalRV_max = QtWidgets.QLineEdit(OrbitOptimizeDialog)
        self.terminalRV_max.setGeometry(QtCore.QRect(280, 520, 91, 18))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.terminalRV_max.setFont(font)
        self.terminalRV_max.setToolTip("")
        self.terminalRV_max.setFrame(False)
        self.terminalRV_max.setReadOnly(True)
        self.terminalRV_max.setObjectName("terminalRV_max")
        self.groupBox = QtWidgets.QGroupBox(OrbitOptimizeDialog)
        ...
        self.box_initialtime = QtWidgets.QGroupBox(OrbitOptimizeDialog)
        ...
        self.it_ff = QtWidgets.QPushButton(self.groupBox_itsr)
        ...
        self.it_fb = QtWidgets.QPushButton(self.groupBox_itsr)
        ...
        self.label_6 = QtWidgets.QLabel(self.groupBox_itsr)
        self.label_6.setGeometry(QtCore.QRect(70, 20, 41, 16))
        self.label_6.setAlignment(QtCore.Qt.AlignCenter)
        self.label_6.setObjectName("label_6")
        self.groupBox_6 = QtWidgets.QGroupBox(OrbitOptimizeDialog)
        self.groupBox_6.setGeometry(QtCore.QRect(10, 290, 581, 141))
        self.groupBox_6.setObjectName("groupBox_6")
        self.sl_duration = QtWidgets.QSlider(self.groupBox_6)
        ...
        self.duration = QtWidgets.QLineEdit(self.groupBox_6)
        ...
        self.terminaltime = QtWidgets.QLineEdit(self.groupBox_6)
        ...
        self.label_ttto = QtWidgets.QLabel(self.groupBox_6)
        ...
        self.label_ttfrom = QtWidgets.QLabel(self.groupBox_6)
        ...
        self.tt_b = QtWidgets.QPushButton(self.groupBox_6)
        ...
        self.tt_f = QtWidgets.QPushButton(self.groupBox_6)
        ...
        self.groupBox_ttsr = QtWidgets.QGroupBox(self.groupBox_6)
        ...
        self.tt_fb = QtWidgets.QPushButton(self.groupBox_ttsr)
        ...
        self.tt_ff = QtWidgets.QPushButton(self.groupBox_ttsr)
        ...
        self.label_11 = QtWidgets.QLabel(self.groupBox_ttsr)
        ...
        self.totalDV_max = QtWidgets.QLineEdit(OrbitOptimizeDialog)
        self.totalDV_max.setGeometry(QtCore.QRect(470, 519, 91, 18))
        font = QtGui.QFont()
        font.setFamily("Lucida Console")
        self.totalDV_max.setFont(font)
        self.totalDV_max.setToolTip("")
        self.totalDV_max.setFrame(False)
        self.totalDV_max.setReadOnly(True)
        self.totalDV_max.setObjectName("totalDV_max")
        self.label_21 = QtWidgets.QLabel(OrbitOptimizeDialog)
    ...
    def retranslateUi(self, OrbitOptimizeDialog):
        ...
        self.starttime.setToolTip(_translate("OrbitOptimizeDialog", "Start time"))
        ...
        self.label_17.setText(_translate("OrbitOptimizeDialog", "Max."))
        self.groupBox.setTitle(_translate("OrbitOptimizeDialog", "Look at"))
        self.tobarycenter.setToolTip(_translate("OrbitOptimizeDialog", "Solar System Barycenter"))
        self.tobarycenter.setText(_translate("OrbitOptimizeDialog", "SSB"))
        self.toprobe.setText(_translate("OrbitOptimizeDialog", "Probe"))
        self.totarget.setText(_translate("OrbitOptimizeDialog", "Target"))
        ...
        self.label_19.setText(_translate("OrbitOptimizeDialog", "Max."))
        ...
        self.box_initialtime.setTitle(_translate("OrbitOptimizeDialog", "Start Time"))
        ...
        self.groupBox_6.setTitle(_translate("OrbitOptimizeDialog", "Flight Time"))
        ...
        self.label_11.setText(_translate("OrbitOptimizeDialog", "Shift"))
        self.groupBox_2.setTitle(_translate("OrbitOptimizeDialog", "by"))
        ...
        self.label_21.setText(_translate("OrbitOptimizeDialog", "Max."))
        self.label_22.setText(_translate("OrbitOptimizeDialog", "Current"))
        self.clearstat.setText(_translate("OrbitOptimizeDialog", "Clear Statistics"))
        self.label_23.setText(_translate("OrbitOptimizeDialog", "phi (deg)"))
        self.label_24.setText(_translate("OrbitOptimizeDialog", "elv (deg)"))
        self.reopenbutton.setText(_translate("OrbitOptimizeDialog", "SHOW Orbit"))
