...
class Ui_ShowOrbitControl(object):
    ...
    def retranslateUi(self, ShowOrbitControl):
        ...
        self.timescale.setToolTip(_translate("ShowOrbitControl", "The value specifies granularity (or fineness) of the Prediction Time.  Larger value makes time steps larger."))
        self.label_2.setText(_translate("ShowOrbitControl", "Granularity"))
