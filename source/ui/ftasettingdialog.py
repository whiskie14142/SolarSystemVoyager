...
class Ui_ftasettingdialog(object):
    def setupUi(self, ftasettingdialog):
        ...
        self.fromshoworbit.setGeometry(QtCore.QRect(30, 20, 391, 17))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        self.fromshoworbit.setFont(font)
        ...
        self.directinput.setGeometry(QtCore.QRect(30, 40, 391, 17))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        self.directinput.setFont(font)
        ...
        self.selTargetcenter.setGeometry(QtCore.QRect(30, 20, 391, 17))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        self.selTargetcenter.setFont(font)
        ...
        self.selBplanecoord.setGeometry(QtCore.QRect(30, 60, 391, 17))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        self.selBplanecoord.setFont(font)
        self.selBplanecoord.setObjectName("selBplanecoord")
        self.selOLcoord = QtWidgets.QRadioButton(self.groupBox_3)
        self.selOLcoord.setGeometry(QtCore.QRect(30, 170, 391, 17))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        self.selOLcoord.setFont(font)
        ...
        font.setFamily("Yu Gothic UI")
        font.setPointSize(9)
        self.Bplanecoords.setFont(font)
        ...
        self.label_3.setGeometry(QtCore.QRect(20, 30, 121, 17))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 50, 121, 17))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(10)
