...
class Ui_editmandialog(object):
    def setupUi(self, editmandialog):
        ...
        self.label.setGeometry(QtCore.QRect(60, 10, 111, 21))
        self.label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label.setObjectName("label")
        self.mantype = QtWidgets.QComboBox(editmandialog)
        self.mantype.setGeometry(QtCore.QRect(180, 10, 111, 24))
        font = QtGui.QFont()
        ...
        self.label_time.setGeometry(QtCore.QRect(0, 70, 71, 16))
        ...
        self.parameters.setGeometry(QtCore.QRect(80, 120, 352, 162))
        ...
        self.cancelbutton.setGeometry(QtCore.QRect(490, 290, 91, 23))
        self.cancelbutton.setAutoDefault(False)
        self.cancelbutton.setObjectName("cancelbutton")
        self.showorbit = QtWidgets.QPushButton(editmandialog)
        self.showorbit.setEnabled(False)
        self.showorbit.setGeometry(QtCore.QRect(490, 40, 91, 23))
        ...
        self.computeFTA.setGeometry(QtCore.QRect(490, 80, 91, 23))
        ...
        self.sysMessage.setGeometry(QtCore.QRect(440, 210, 191, 71))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.frameDT.setGeometry(QtCore.QRect(80, 40, 351, 71))
