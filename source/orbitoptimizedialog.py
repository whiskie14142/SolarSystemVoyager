...
class Ui_OrbitOptimizeDialog(object):
    def setupUi(self, OrbitOptimizeDialog):
        ...
        self.sl_inittime.setGeometry(QtCore.QRect(35, 65, 511, 22))
        ...
        self.label_it.setGeometry(QtCore.QRect(250, 90, 81, 20))
        ...
        self.initialtime.setGeometry(QtCore.QRect(340, 90, 191, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lucida Console"))
        ...
        self.label_itfrom.setGeometry(QtCore.QRect(5, 45, 71, 16))
        ...
        self.label_itto.setGeometry(QtCore.QRect(505, 45, 71, 16))
        ...
        self.it_b.setGeometry(QtCore.QRect(8, 65, 21, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.it_f.setGeometry(QtCore.QRect(552, 65, 21, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.groupBox_4 = QtGui.QGroupBox(self.box_initialtime)
        self.groupBox_4.setGeometry(QtCore.QRect(140, 12, 331, 50))
        self.groupBox_4.setObjectName(_fromUtf8("groupBox_4"))
        self.it_wide = QtGui.QRadioButton(self.groupBox_4)
        self.it_wide.setGeometry(QtCore.QRect(120, 20, 51, 16))
        self.it_wide.setChecked(True)
        self.it_wide.setObjectName(_fromUtf8("it_wide"))
        self.it_narrow = QtGui.QRadioButton(self.groupBox_4)
        self.it_narrow.setGeometry(QtCore.QRect(50, 20, 61, 16))
        self.it_narrow.setChecked(False)
        self.it_narrow.setObjectName(_fromUtf8("it_narrow"))
        self.it_ff = QtGui.QPushButton(self.groupBox_4)
        self.it_ff.setGeometry(QtCore.QRect(270, 17, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.it_fb = QtGui.QPushButton(self.groupBox_4)
        self.it_fb.setGeometry(QtCore.QRect(200, 17, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_6.setGeometry(QtCore.QRect(230, 20, 41, 16))
        ...
        self.sl_duration.setGeometry(QtCore.QRect(35, 65, 511, 22))
        ...
        self.label_7.setGeometry(QtCore.QRect(30, 90, 111, 20))
        self.label_7.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_7.setObjectName(_fromUtf8("label_7"))
        self.duration = QtGui.QLineEdit(self.groupBox_6)
        self.duration.setGeometry(QtCore.QRect(150, 90, 81, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lucida Console"))
        ...
        self.label_8.setGeometry(QtCore.QRect(250, 90, 81, 20))
        self.label_8.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.terminaltime = QtGui.QLineEdit(self.groupBox_6)
        self.terminaltime.setGeometry(QtCore.QRect(340, 90, 191, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Lucida Console"))
        ...
        self.label_ttto.setGeometry(QtCore.QRect(505, 45, 71, 16))
        ...
        self.label_ttfrom.setGeometry(QtCore.QRect(5, 45, 71, 16))
        ...
        self.tt_b.setGeometry(QtCore.QRect(8, 65, 21, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tt_f.setGeometry(QtCore.QRect(552, 65, 21, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(140, 12, 331, 50))
        self.groupBox_5.setObjectName(_fromUtf8("groupBox_5"))
        self.tt_wide = QtGui.QRadioButton(self.groupBox_5)
        self.tt_wide.setGeometry(QtCore.QRect(120, 20, 61, 16))
        self.tt_wide.setChecked(True)
        self.tt_wide.setObjectName(_fromUtf8("tt_wide"))
        self.tt_narrow = QtGui.QRadioButton(self.groupBox_5)
        self.tt_narrow.setGeometry(QtCore.QRect(50, 20, 61, 16))
        self.tt_narrow.setChecked(False)
        self.tt_narrow.setObjectName(_fromUtf8("tt_narrow"))
        self.tt_fb = QtGui.QPushButton(self.groupBox_5)
        self.tt_fb.setGeometry(QtCore.QRect(200, 17, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tt_ff = QtGui.QPushButton(self.groupBox_5)
        self.tt_ff.setGeometry(QtCore.QRect(270, 17, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_11.setGeometry(QtCore.QRect(230, 20, 41, 20))
    ...
    def retranslateUi(self, OrbitOptimizeDialog):
        ...
        self.groupBox_2.setTitle(_translate("OrbitOptimizeDialog", "Flight Time is Arranged by", None))
        ...
        self.groupBox_4.setTitle(_translate("OrbitOptimizeDialog", "Slider Range", None))
        ...
        self.groupBox_6.setTitle(_translate("OrbitOptimizeDialog", "Arrange Flight Time", None))
        ...
        self.groupBox_5.setTitle(_translate("OrbitOptimizeDialog", "Slider Range", None))
