...
class Ui_OrbitOptimizeDialog(object):
    def setupUi(self, OrbitOptimizeDialog):
        ...
        self.it_wide.setGeometry(QtCore.QRect(170, 10, 121, 16))
        ...
        self.it_narrow.setGeometry(QtCore.QRect(170, 30, 121, 16))
        ...
        self.it_ff.setGeometry(QtCore.QRect(110, 17, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.it_fb.setGeometry(QtCore.QRect(40, 17, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tt_wide.setGeometry(QtCore.QRect(170, 10, 121, 16))
        ...
        self.tt_narrow.setGeometry(QtCore.QRect(170, 30, 121, 16))
        ...
        self.tt_fb.setGeometry(QtCore.QRect(40, 17, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tt_ff.setGeometry(QtCore.QRect(110, 17, 31, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_11.setGeometry(QtCore.QRect(70, 19, 41, 20))
    ...
    def retranslateUi(self, OrbitOptimizeDialog):
        ...
        self.it_wide.setText(_translate("OrbitOptimizeDialog", "Wide    (500 days)", None))
        self.it_narrow.setText(_translate("OrbitOptimizeDialog", "Narrow (100 days)", None))
        ...
        self.tt_wide.setText(_translate("OrbitOptimizeDialog", "Wide    (500 days)", None))
        self.tt_narrow.setText(_translate("OrbitOptimizeDialog", "Narrow (100 days)", None))
