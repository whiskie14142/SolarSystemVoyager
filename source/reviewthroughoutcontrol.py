...
class Ui_ReviewThroughoutControl(object):
    ...
    def retranslateUi(self, ReviewThroughoutControl):
        ...
        self.delta_t_edit.setToolTip(_translate("ReviewThroughoutControl", "Delta T (current - start)", None))
        ...
        self.starttime.setToolTip(_translate("ReviewThroughoutControl", "Start time", None))
        ...
        self.currenttime.setToolTip(_translate("ReviewThroughoutControl", "Current time (Copiable)", None))
        self.RVTvel.setToolTip(_translate("ReviewThroughoutControl", "Abs. Relative Velocity (Copiable)", None))
