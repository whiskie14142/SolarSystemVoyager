...
class Ui_ReviewThroughoutControl(object):
    def setupUi(self, ReviewThroughoutControl):
        ...
        self.fastbackward.setGeometry(QtCore.QRect(270, 80, 41, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.backward.setGeometry(QtCore.QRect(320, 80, 41, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.forward.setGeometry(QtCore.QRect(370, 80, 41, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.fastforward.setGeometry(QtCore.QRect(420, 80, 41, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.showkepler = QtGui.QCheckBox(ReviewThroughoutControl)
        ...
        self.starttime = QtGui.QLabel(ReviewThroughoutControl)
        ...
        self.RPTrange = QtGui.QLabel(ReviewThroughoutControl)
        ...
        self.RPTphi = QtGui.QLabel(ReviewThroughoutControl)
        ...
        self.RPTelv = QtGui.QLabel(ReviewThroughoutControl)
        ...
        self.LoSVvel = QtGui.QLabel(ReviewThroughoutControl)
        ...
        self.label_19.setGeometry(QtCore.QRect(315, 100, 111, 20))
        ...
        self.showplanets = QtGui.QCheckBox(ReviewThroughoutControl)
        ...
        self.previousman.setGeometry(QtCore.QRect(210, 80, 41, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.nextman.setGeometry(QtCore.QRect(480, 80, 41, 23))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.showmantype = QtGui.QCheckBox(ReviewThroughoutControl)
        self.showmantype.setGeometry(QtCore.QRect(160, 50, 131, 16))
    ...
    def retranslateUi(self, ReviewThroughoutControl):
        ...
        self.delta_t_edit.setToolTip(_translate("ReviewThroughoutControl", "Delta T (you need click apply button)", None))
        ...
        self.timescale.setToolTip(_translate("ReviewThroughoutControl", "Select powers", None))
        self.label_2.setText(_translate("ReviewThroughoutControl", "Hopping", None))
        self.showkepler.setText(_translate("ReviewThroughoutControl", "Show Kepler Orbit", None))
        ...
        self.currenttime.setToolTip(_translate("ReviewThroughoutControl", "Prediction Time (Copiable)", None))
        self.RVTvel.setToolTip(_translate("ReviewThroughoutControl", "Relative Velocity abs. (Copiable)", None))
        self.RVTphi.setToolTip(_translate("ReviewThroughoutControl", "Relative Velocity phi (Copiable)", None))
        self.RVTelv.setToolTip(_translate("ReviewThroughoutControl", "Relative Velocity elv (Copiable)", None))
        ...
        self.showplanets.setText(_translate("ReviewThroughoutControl", "Show Planets", None))
        ...
        self.showmantype.setText(_translate("ReviewThroughoutControl", "Show Maneuver Type", None))
