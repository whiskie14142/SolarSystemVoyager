...
class Ui_ftasettingdialog(object):
    ...
    def retranslateUi(self, ftasettingdialog):
        ...
        self.label_2.setText(_translate("ftasettingdialog", "offset distance (km)", None))
        ...
        self.selBplanecoord.setText(_translate("ftasettingdialog", "Specify B-plane Coordinates", None))
        self.selOLcoord.setText(_translate("ftasettingdialog", "Specify Orbit Local Coordinates", None))
