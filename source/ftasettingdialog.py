...
class Ui_ftasettingdialog(object):
    def setupUi(self, ftasettingdialog):
        ...
        self.label.setGeometry(QtCore.QRect(150, 60, 121, 16))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(20, 120, 441, 291))
    ...
    def retranslateUi(self, ftasettingdialog):
        ...
        self.selBplanecoord.setText(_translate("ftasettingdialog", "B-plane Coordinates", None))
        self.selOLcoord.setText(_translate("ftasettingdialog", "Orbit Local Coordinates", None))
