...
class Ui_FlightReviewControl(object):
    ...
    def retranslateUi(self, FlightReviewControl):
        ...
        self.label.setText(_translate("FlightReviewControl", "Elapsed Time (days)", None))
        ...
        self.label_6.setText(_translate("FlightReviewControl", "Start Time", None))
        self.label_4.setText(_translate("FlightReviewControl", "Watching Time", None))
