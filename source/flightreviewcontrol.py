...
class Ui_FlightReviewControl(object):
    ...
    def retranslateUi(self, FlightReviewControl):
        ...
        self.delta_t_edit.setToolTip(_translate("FlightReviewControl", "Delta T (current - start)", None))
        ...
        self.starttime.setToolTip(_translate("FlightReviewControl", "Start time", None))
        ...
        self.currenttime.setToolTip(_translate("FlightReviewControl", "Current time (Copiable)", None))
        self.RVTvel.setToolTip(_translate("FlightReviewControl", "Abs. Relative Velocity (Copiable)", None))
